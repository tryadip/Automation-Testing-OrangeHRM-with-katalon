...
WebUI.setText(findTestObject('Add User/in_Username'),"sukia123")
WebUI.setText(findTestObject('Add User/in_Password'),"sukia123")
WebUI.setText(findTestObject('Add User/in_Confirm'),"sukia123")
WebUI.click(findTestObject('Add User/btn_Save'))